...
const App = () => {
    ...
    const mintToken = async () => {
        if (!mintAddress) {
            alert('Please enter an address to mint the token to.');
            return;
        }
        ...
        try {
            ...
            await contract.mint(mintAddress);
